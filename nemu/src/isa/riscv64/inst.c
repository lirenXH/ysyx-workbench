...
#define INSTPAT_MATCH(s, name, type, ... /* body */ ) { \
  ...
  INSTPAT("??????? ????? ????? ??? ????? 00110 11", addiw  , I, R(dest) = SEXT(BITS((src1 + src2),31,0),32));                        //yes
  ...
  INSTPAT("0000000 ????? ????? 101 ????? 00110 11", srliw  , I, shamt = BITS(src2,5,0),R(dest) = SEXT((BITS(src1,31,0) >> shamt),32));
