...
#define INSTPAT_MATCH(s, name, type, ... /* body */ ) { \
  ...
  INSTPAT("010000? ????? ????? 101 ????? 00100 11", srai   , I, shamt = BITS(src2,5,0),R(dest) = src1 >> shamt);                      //doubt  suanshuyiwei
  INSTPAT("010000? ????? ????? 101 ????? 00110 11", sraiw  , I, shamt = BITS(src2,5,0),R(dest) = SEXT((BITS(src1,31,0) >> shamt),32));//doubt  suanshuyiwei
  ...
  INSTPAT("??????? ????? ????? 010 ????? 00000 11", lw     , I, R(dest) = SEXT(Mr(src1 + src2, 4),64));                                //yes?
