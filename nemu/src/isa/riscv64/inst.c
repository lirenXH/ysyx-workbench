...
#define INSTPAT_MATCH(s, name, type, ... /* body */ ) { \
  ...
  INSTPAT("000000? ????? ????? 101 ????? 00100 11", srli   , I, shamt = BITS(src2,5,0),R(dest) = (unsigned)src1 >> (unsigned)shamt);
  INSTPAT("000000? ????? ????? 101 ????? 00110 11", srliw  , I, shamt = BITS(src2,5,0),R(dest) = SEXT((unsigned)(BITS(src1,31,0) >> (unsigned)shamt),32));
