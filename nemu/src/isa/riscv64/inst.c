...
#define INSTPAT_MATCH(s, name, type, ... /* body */ ) { \
  ...
  INSTPAT("0000001 ????? ????? 110 ????? 01100 11", rem    , R, R(dest) = (~(src1 % src2))+1); //new
  INSTPAT("0000001 ????? ????? 100 ????? 01110 11", divw   , R, R(dest) = SEXT((BITS(src1,31,0) / BITS(src2,31,0)),32));               //doubt
  INSTPAT("0000001 ????? ????? 100 ????? 01100 11", div    , R, R(dest) = ~((sword_t)src1/(sword_t)src2)+1);printf("%ld,src1%ld,src2%ld\n",src1/src2,src1,src2);; //new
