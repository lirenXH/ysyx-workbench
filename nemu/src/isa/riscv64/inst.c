...
#define INSTPAT_MATCH(s, name, type, ... /* body */ ) { \
  ...
  INSTPAT("0000001 ????? ????? 110 ????? 01110 11", remw   , R, R(dest) = SEXT(  BITS((((sword_t)BITS(src1,31,0))  %  ((sword_t)BITS(src2,31,0))),31,0)  ,32)); //!!!!!
  INSTPAT("0000001 ????? ????? 110 ????? 01100 11", rem    , R, R(dest) = (sword_t)src1 % (sword_t)src2); //new
  INSTPAT("0000001 ????? ????? 100 ????? 01110 11", divw   , R, R(dest) = SEXT( ((sword_t)BITS(src1,31,0) / (sword_t)BITS(src2,31,0)) ,32));               //doubt
