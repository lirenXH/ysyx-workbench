...
#define INSTPAT_MATCH(s, name, type, ... /* body */ ) { \
  ...
  INSTPAT("000000? ????? ????? 101 ????? 00110 11", srliw  , I, R(dest) = SEXT((BITS(src1,31,0) >> BITS(src2,5,0)),32));
  ...
  INSTPAT("010000? ????? ????? 101 ????? 00100 11", srai   , I, R(dest) = (src1 >> BITS(src2,5,0)));                      //doubt  suanshuyiwei
