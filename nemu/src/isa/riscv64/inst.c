...
#define INSTPAT_MATCH(s, name, type, ... /* body */ ) { \
  ...
  INSTPAT("??????? ????? ????? 110 ????? 11000 11", bltu   , B, if((unsigned)src1 < (unsigned)src2) s->dnpc = s->pc + dest);
  ...
  INSTPAT("0100000 ????? ????? 101 ????? 01110 11", sraw   , R, R(dest) = SEXT((signed)(BITS(src1,31,0) >> BITS(src2,4,0)),32));               //doubt  suanshuyiwei
