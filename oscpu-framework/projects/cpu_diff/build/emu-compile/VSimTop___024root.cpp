...
extern const VlUnpacked<QData/*63:0*/, 128> VSimTop__ConstPool__TABLE_e848d208_0;
...
VL_INLINE_OPT void VSimTop___024root___sequent__TOP__1(VSimTop___024root* vlSelf) {
    ...
    vlSelf->SimTop__DOT__MEM__DOT__ram__DOT__wmask 
        = VSimTop__ConstPool__TABLE_e848d208_0[__Vtableidx1];
    ...
    if (((IData)(vlSelf->SimTop__DOT__i_ram_en) & (0ULL 
                                                   != vlSelf->SimTop__DOT__IF__DOT__nextpc))) {
        vlSelf->SimTop__DOT__inst = ((0ULL == (7ULL 
                                               & vlSelf->SimTop__DOT__IF__DOT__nextpc))
                                      ? (IData)(vlSelf->SimTop__DOT__inst_ram__DOT__inst_ext)
                                      : (IData)((vlSelf->SimTop__DOT__inst_ram__DOT__inst_ext 
                                                 >> 0x20U)));
    } else if (vlSelf->SimTop__DOT__i_ram_en) {
        vlSelf->SimTop__DOT__inst = 0x13U;
    }
    if (vlSelf->reset) {
    ...
    vlSelf->SimTop__DOT__es_alu_result = ((0x80000U 
                                           ...
                                           : vlSelf->SimTop__DOT__EXE__DOT__alu__DOT__sel_result);
    __Vtemp23[2U] = ((((((((((0U == (0x1fU & (vlSelf->SimTop__DOT__EXE__DOT__ds_to_es_bus_r[8U] 
                                              >> 0xfU))) 
    ...
    vlSelf->SimTop__DOT__bru_to_fs_bus[4U] = ((IData)(
                                                      (vlSelf->SimTop__DOT__es_alu_result 
                                                       >> 0x20U)) 
                                              >> 0x1dU);
    vlSelf->SimTop__DOT__IF__DOT__nextpc = ((((- (QData)((IData)(
                                                                 (0U 
                                                                  == 
                                                                  (3U 
...
VL_INLINE_OPT void VSimTop___024root___combo__TOP__5(VSimTop___024root* vlSelf) {
    ...
    vlSelf->SimTop__DOT__pcwrite = ((~ (IData)(vlSelf->reset)) 
                                    & ((vlSelf->SimTop__DOT__es_to_ms_bus[2U] 
                                        >> 0xbU) & 
                                       (((0x1fU & vlSelf->SimTop__DOT__es_to_ms_bus[2U]) 
                                         == (0x1fU 
                                             & (vlSelf->SimTop__DOT__ID__DOT__inst 
                                                >> 0xfU))) 
                                        | ((0x1fU & 
    ...
    vlSelf->SimTop__DOT__IF__DOT__fs_allowin = (1U 
                                                & (((~ (IData)(vlSelf->SimTop__DOT__IF__DOT__fs_valid)) 
                                                    | (IData)(vlSelf->SimTop__DOT__ds_allowin)) 
                                                   & (~ (IData)(vlSelf->SimTop__DOT__pcwrite))));
    vlSelf->SimTop__DOT__i_ram_en = (((~ (IData)(vlSelf->reset)) 
                                      & (IData)(vlSelf->SimTop__DOT__IF__DOT__fs_allowin)) 
                                     & (~ (IData)(vlSelf->SimTop__DOT__pcwrite)));
    VSimTop___024unit____Vdpiimwrap_ram_read_helper_TOP____024unit(vlSelf->SimTop__DOT__i_ram_en, 
                                                                   ((vlSelf->SimTop__DOT__IF__DOT__nextpc 
                                                                     - 0x80000000ULL) 
