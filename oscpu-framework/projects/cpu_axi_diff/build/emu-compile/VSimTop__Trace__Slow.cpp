...
void VSimTop___024root__traceFullSub0(VSimTop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        VL_EXTEND_WQ(65,64, __Vtemp21, vlSelf->SimTop__DOT__if_addr);
        ...
        VL_EXTEND_WQ(65,64, __Vtemp22, vlSelf->SimTop__DOT__if_addr);
        ...
        VL_EXTEND_WQ(65,64, __Vtemp23, vlSelf->SimTop__DOT__if_addr);
        tracep->fullBit(oldp+28,((0U == (7U & __Vtemp23[0U]))));
        VL_EXTEND_WQ(65,64, __Vtemp24, vlSelf->SimTop__DOT__if_addr);
        tracep->fullCData(oldp+29,((7U & __Vtemp24[0U])),4);
        VL_EXTEND_WQ(65,64, __Vtemp25, vlSelf->SimTop__DOT__if_addr);
        tracep->fullCData(oldp+30,((0xfU & ((IData)(3U) 
                                            + (7U & 
                                               __Vtemp25[0U])))),4);
        VL_EXTEND_WQ(65,64, __Vtemp26, vlSelf->SimTop__DOT__if_addr);
        tracep->fullBit(oldp+31,((1U & (((IData)(3U) 
                                         + (7U & __Vtemp26[0U])) 
                                        >> 3U))));
        VL_EXTEND_WQ(65,64, __Vtemp27, vlSelf->SimTop__DOT__if_addr);
        tracep->fullCData(oldp+32,((0x38U & (__Vtemp27[0U] 
                                             << 3U))),6);
        VL_EXTEND_WQ(65,64, __Vtemp28, vlSelf->SimTop__DOT__if_addr);
        ...
        __Vtemp29[2U] = 0U;
        __Vtemp29[3U] = 0U;
        VL_EXTEND_WQ(65,64, __Vtemp30, vlSelf->SimTop__DOT__if_addr);
        ...
        __Vtemp32[2U] = 0U;
        __Vtemp32[3U] = 0U;
        VL_EXTEND_WQ(65,64, __Vtemp33, vlSelf->SimTop__DOT__if_addr);
        ...
        __Vtemp35[2U] = 0U;
        __Vtemp35[3U] = 0U;
        VL_EXTEND_WQ(65,64, __Vtemp36, vlSelf->SimTop__DOT__if_addr);
        ...
        tracep->fullBit(oldp+399,(vlSelf->SimTop__DOT__u_cpu__DOT__w_ena));
        tracep->fullBit(oldp+400,(vlSelf->clock));
        tracep->fullBit(oldp+401,(vlSelf->reset));
        tracep->fullQData(oldp+402,(vlSelf->io_logCtrl_log_begin),64);
        tracep->fullQData(oldp+404,(vlSelf->io_logCtrl_log_end),64);
        tracep->fullQData(oldp+406,(vlSelf->io_logCtrl_log_level),64);
        tracep->fullBit(oldp+408,(vlSelf->io_perfInfo_clean));
        tracep->fullBit(oldp+409,(vlSelf->io_perfInfo_dump));
        tracep->fullBit(oldp+410,(vlSelf->io_uart_out_valid));
        tracep->fullCData(oldp+411,(vlSelf->io_uart_out_ch),8);
        tracep->fullBit(oldp+412,(vlSelf->io_uart_in_valid));
        tracep->fullCData(oldp+413,(vlSelf->io_uart_in_ch),8);
        tracep->fullBit(oldp+414,(vlSelf->io_memAXI_0_aw_ready));
        tracep->fullBit(oldp+415,(vlSelf->io_memAXI_0_aw_valid));
        tracep->fullQData(oldp+416,(vlSelf->io_memAXI_0_aw_bits_addr),64);
        tracep->fullCData(oldp+418,(vlSelf->io_memAXI_0_aw_bits_prot),3);
        tracep->fullCData(oldp+419,(vlSelf->io_memAXI_0_aw_bits_id),4);
        tracep->fullBit(oldp+420,(vlSelf->io_memAXI_0_aw_bits_user));
        tracep->fullCData(oldp+421,(vlSelf->io_memAXI_0_aw_bits_len),8);
        tracep->fullCData(oldp+422,(vlSelf->io_memAXI_0_aw_bits_size),3);
        tracep->fullCData(oldp+423,(vlSelf->io_memAXI_0_aw_bits_burst),2);
        tracep->fullBit(oldp+424,(vlSelf->io_memAXI_0_aw_bits_lock));
        tracep->fullCData(oldp+425,(vlSelf->io_memAXI_0_aw_bits_cache),4);
        tracep->fullCData(oldp+426,(vlSelf->io_memAXI_0_aw_bits_qos),4);
        tracep->fullBit(oldp+427,(vlSelf->io_memAXI_0_w_ready));
        tracep->fullBit(oldp+428,(vlSelf->io_memAXI_0_w_valid));
        tracep->fullQData(oldp+429,(vlSelf->io_memAXI_0_w_bits_data[0]),64);
        tracep->fullQData(oldp+431,(vlSelf->io_memAXI_0_w_bits_data[1]),64);
        tracep->fullQData(oldp+433,(vlSelf->io_memAXI_0_w_bits_data[2]),64);
        tracep->fullQData(oldp+435,(vlSelf->io_memAXI_0_w_bits_data[3]),64);
        tracep->fullCData(oldp+437,(vlSelf->io_memAXI_0_w_bits_strb),8);
        tracep->fullBit(oldp+438,(vlSelf->io_memAXI_0_w_bits_last));
        tracep->fullBit(oldp+439,(vlSelf->io_memAXI_0_b_ready));
        tracep->fullBit(oldp+440,(vlSelf->io_memAXI_0_b_valid));
        tracep->fullCData(oldp+441,(vlSelf->io_memAXI_0_b_bits_resp),2);
        tracep->fullCData(oldp+442,(vlSelf->io_memAXI_0_b_bits_id),4);
        tracep->fullBit(oldp+443,(vlSelf->io_memAXI_0_b_bits_user));
        tracep->fullBit(oldp+444,(vlSelf->io_memAXI_0_ar_ready));
        tracep->fullBit(oldp+445,(vlSelf->io_memAXI_0_ar_valid));
        tracep->fullQData(oldp+446,(vlSelf->io_memAXI_0_ar_bits_addr),64);
        tracep->fullCData(oldp+448,(vlSelf->io_memAXI_0_ar_bits_prot),3);
        tracep->fullCData(oldp+449,(vlSelf->io_memAXI_0_ar_bits_id),4);
        tracep->fullBit(oldp+450,(vlSelf->io_memAXI_0_ar_bits_user));
        tracep->fullCData(oldp+451,(vlSelf->io_memAXI_0_ar_bits_len),8);
        tracep->fullCData(oldp+452,(vlSelf->io_memAXI_0_ar_bits_size),3);
        tracep->fullCData(oldp+453,(vlSelf->io_memAXI_0_ar_bits_burst),2);
        tracep->fullBit(oldp+454,(vlSelf->io_memAXI_0_ar_bits_lock));
        tracep->fullCData(oldp+455,(vlSelf->io_memAXI_0_ar_bits_cache),4);
        tracep->fullCData(oldp+456,(vlSelf->io_memAXI_0_ar_bits_qos),4);
        tracep->fullBit(oldp+457,(vlSelf->io_memAXI_0_r_ready));
        tracep->fullBit(oldp+458,(vlSelf->io_memAXI_0_r_valid));
        tracep->fullCData(oldp+459,(vlSelf->io_memAXI_0_r_bits_resp),2);
        tracep->fullQData(oldp+460,(vlSelf->io_memAXI_0_r_bits_data[0]),64);
        tracep->fullQData(oldp+462,(vlSelf->io_memAXI_0_r_bits_data[1]),64);
        tracep->fullQData(oldp+464,(vlSelf->io_memAXI_0_r_bits_data[2]),64);
        tracep->fullQData(oldp+466,(vlSelf->io_memAXI_0_r_bits_data[3]),64);
        tracep->fullBit(oldp+468,(vlSelf->io_memAXI_0_r_bits_last));
        tracep->fullCData(oldp+469,(vlSelf->io_memAXI_0_r_bits_id),4);
        tracep->fullBit(oldp+470,(vlSelf->io_memAXI_0_r_bits_user));
        tracep->fullQData(oldp+471,(vlSelf->io_memAXI_0_r_bits_data
                                    [0U]),64);
        tracep->fullBit(oldp+473,(((IData)(vlSelf->io_memAXI_0_ar_ready) 
                                   & (1U == (IData)(vlSelf->SimTop__DOT__u_axi_rw__DOT__r_state)))));
        tracep->fullBit(oldp+474,(((IData)(vlSelf->reset) 
                                   | (0U == (IData)(vlSelf->SimTop__DOT__u_axi_rw__DOT__r_state)))));
        tracep->fullBit(oldp+475,((1U & (IData)(vlSelf->io_memAXI_0_r_bits_resp))));
        __Vtemp38[0U] = 0xffffffffU;
        __Vtemp38[1U] = 0U;
        __Vtemp38[2U] = 0U;
        __Vtemp38[3U] = 0U;
        VL_EXTEND_WQ(65,64, __Vtemp39, vlSelf->SimTop__DOT__if_addr);
        VL_SHIFTL_WWI(128,128,6, __Vtemp40, __Vtemp38, 
                      (0x38U & (__Vtemp39[0U] << 3U)));
        VL_EXTEND_WQ(65,64, __Vtemp41, vlSelf->SimTop__DOT__if_addr);
        tracep->fullQData(oldp+476,(((vlSelf->io_memAXI_0_r_bits_data
                                      [0U] & (((QData)((IData)(
                                                               __Vtemp40[3U])) 
                                               << 0x20U) 
                                              | (QData)((IData)(
                                     ...
                                     << (0x3fU & (- 
                                                  (0x38U 
                                                   & (__Vtemp41[0U] 
                                                      << 3U)))))),64);
        tracep->fullBit(oldp+478,(((IData)(vlSelf->reset)
                                    ? 0U : (1U & ((IData)(vlSelf->SimTop__DOT__u_cpu__DOT__inst_type) 
                                                  >> 4U)))));
        tracep->fullCData(oldp+479,(((IData)(vlSelf->reset)
                                      ? 0U : ((0x10U 
                                               ...
                                               ? (0x1fU 
                                                  & (vlSelf->SimTop__DOT__u_cpu__DOT__inst 
                                                     >> 0xfU))
                                               : 0U))),5);
        tracep->fullQData(oldp+480,(((IData)(vlSelf->reset)
                                      ? 0ULL : ((0x10U 
                                                 & (IData)(vlSelf->SimTop__DOT__u_cpu__DOT__inst_type))
                                                 ? 
                                                ((IData)(vlSelf->reset)
                                                 ...
                                                 (((IData)(vlSelf->reset)
                                                  ...
                                                  ((IData)(vlSelf->reset)
                                                   ...
                                                   : 0ULL))
                                                 : 0ULL))),64);
        tracep->fullQData(oldp+482,(((IData)(vlSelf->reset)
                                      ? 0ULL : ((0x10U 
                                                 & (IData)(vlSelf->SimTop__DOT__u_cpu__DOT__inst_type))
                                                 ? 
                                                (((- (QData)((IData)(
                                                 ...
                                                 | (QData)((IData)(
                                                                   (vlSelf->SimTop__DOT__u_cpu__DOT__inst 
                                                                    >> 0x14U))))
                                                 : 0ULL))),64);
        tracep->fullQData(oldp+484,(((IData)(vlSelf->reset)
                                                ...
                                                [((IData)(vlSelf->reset)
                                                  ...
                                                  ((0x10U 
                                                   ...
                                                   (0x1fU 
                                                    ...
                                                    : 0U))]
                                                 : 0ULL))),64);
        tracep->fullBit(oldp+486,(vlSelf->SimTop__DOT__aw_ready));
        tracep->fullBit(oldp+487,(vlSelf->SimTop__DOT__aw_valid));
        tracep->fullQData(oldp+488,(vlSelf->SimTop__DOT__aw_addr),64);
        tracep->fullCData(oldp+490,(vlSelf->SimTop__DOT__aw_prot),3);
        tracep->fullCData(oldp+491,(vlSelf->SimTop__DOT__aw_id),4);
        tracep->fullBit(oldp+492,(vlSelf->SimTop__DOT__aw_user));
        tracep->fullCData(oldp+493,(vlSelf->SimTop__DOT__aw_len),8);
        tracep->fullCData(oldp+494,(vlSelf->SimTop__DOT__aw_size),3);
        tracep->fullCData(oldp+495,(vlSelf->SimTop__DOT__aw_burst),2);
        tracep->fullBit(oldp+496,(vlSelf->SimTop__DOT__aw_lock));
        tracep->fullCData(oldp+497,(vlSelf->SimTop__DOT__aw_cache),4);
        tracep->fullCData(oldp+498,(vlSelf->SimTop__DOT__aw_qos),4);
        tracep->fullCData(oldp+499,(vlSelf->SimTop__DOT__aw_region),4);
        tracep->fullBit(oldp+500,(vlSelf->SimTop__DOT__w_ready));
        tracep->fullBit(oldp+501,(vlSelf->SimTop__DOT__w_valid));
        tracep->fullQData(oldp+502,(vlSelf->SimTop__DOT__w_data),64);
        tracep->fullCData(oldp+504,(vlSelf->SimTop__DOT__w_strb),8);
        tracep->fullBit(oldp+505,(vlSelf->SimTop__DOT__w_last));
        tracep->fullBit(oldp+506,(vlSelf->SimTop__DOT__w_user));
        tracep->fullBit(oldp+507,(vlSelf->SimTop__DOT__b_ready));
        tracep->fullBit(oldp+508,(vlSelf->SimTop__DOT__b_valid));
        tracep->fullCData(oldp+509,(vlSelf->SimTop__DOT__b_resp),2);
        tracep->fullCData(oldp+510,(vlSelf->SimTop__DOT__b_id),4);
        tracep->fullBit(oldp+511,(vlSelf->SimTop__DOT__b_user));
        ...
        tracep->fullCData(oldp+519,(vlSelf->SimTop__DOT__ar_region),4);
        tracep->fullBit(oldp+520,(1U));
        tracep->fullQData(oldp+521,(vlSelf->SimTop__DOT__data_write),64);
        ...
        VL_EXTEND_WQ(65,64, __Vtemp42, vlSelf->SimTop__DOT__data_write);
        tracep->fullWData(oldp+527,(__Vtemp42),65);
        tracep->fullBit(oldp+530,(((IData)(vlSelf->SimTop__DOT__aw_ready) 
                                   & (IData)(vlSelf->SimTop__DOT__aw_valid))));
        tracep->fullBit(oldp+531,(((IData)(vlSelf->SimTop__DOT__b_ready) 
        ...
        tracep->fullQData(oldp+541,(vlSelf->SimTop__DOT__u_cpu__DOT__If_stage__DOT__addr),64);
